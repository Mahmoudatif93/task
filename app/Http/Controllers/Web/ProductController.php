...
class ProductController extends Controller
{
    public function index(Request $request)
    {
      ...
      $request->session()->put('priceproduct',$last_total );
        ...
        $Featuredproducts = Product::when($request->search, function ($q) use ($request) {
        ...
        return view('web.products.ourproducts', compact('categories', 'products', 'title','anotherproducts','total_price2','total_price','Featuredproducts','last_total'));
    } //end of index
