                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td>{{ $product->hours }}</td>
                                    @if($product->active==0)
                                    <td><a href="{{ route('dashboard.products.pactive', $product->id) }}" class="btn btn-primary btn-sm">not active</a></td>

                                    @else
                                    <td><a href="{{ route('dashboard.products.pnotactive',$product->id) }}" class="btn btn-success btn-sm">active</a></td>
