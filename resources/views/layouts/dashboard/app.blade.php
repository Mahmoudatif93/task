...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ route('dashboard.index') }}" class="logo">
            ...
            <span class="logo-mini"><b>F</t>ask</span>
            <span class="logo-lg"><b>task</b></span>
                   ...
                   <!-- <li class="dropdown notifications-menu">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        @if(!empty(auth()->user()->image))
                            ...
                            @else
                            <img src="{{ asset('uploads/user_images/default.jpg') }}" class="user-image" alt="User Image">
                            @endif
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <a href="{{ route('dashboard.forgetpass') }}" class="btn btn-default btn-flat">Settings</a>
<br>
